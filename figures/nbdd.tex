\begin{tikzpicture}[scale=0.85, transform shape]
  ...
  \node[thick, draw=black, ellipse, minimum height=8mm, below=12mm of n1, text centered] (n3) {$u_3 : Z$}
    edge[arrin] node[left] {$0$} (n1);
  \node[thick, draw=black, ellipse, minimum height=8mm, left=12mm of n3, text centered] (n2) {$u_2 : Y$}
    edge[arrin] node[above] {$0$} (n1);
  \node[thick, draw=black, ellipse, minimum height=8mm, right=12mm of n3, text centered] (n4) {$u_4 : W$}
